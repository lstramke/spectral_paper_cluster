...
class KMeansExperiment(BaseExperiment[ParsedExperimentConfig]):
    """Encapsulates the KMeans + Fasttext multi-run experiment logic."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run Fasttext + KMeans experiment")
    parser.add_argument(
        "--config",
        type=str,
        required=True,
