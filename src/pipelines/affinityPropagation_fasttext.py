...
class AffinityPropagationFasttextPipeline(ExperimentPipeline):
    """Pipeline: Fasttext -> Affinity Propagation -> evaluation/interpretation with Optuna optimization."""
    ...
    def _run_single_trial(
        ...
        pipeline_result = PipelineResult(
            ...
            interpretation=None,
            metadata={"pipeline": "affinityPropagation_fasttext", "damping": damping, "random_state": random_state},
        )
    ...
    def run_many(
        ...
        return MultiRunPipelineResult(
            ...
            metadata={"pipeline": "affinityPropagation_fasttext", "n_trials": n_trials, "optuna_seed": 42, "scoring": "silhouette, calinski_harabasz, davies_bouldin"},
        )
