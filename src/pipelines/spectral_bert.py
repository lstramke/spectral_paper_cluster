...
class SpectralBertPipeline(ExperimentPipeline):
    """Pipeline: bert -> SPECTRAL -> evaluation/interpretation with Optuna optimization.
    ...
    def _run_single_trial(
        ...
        pipeline_result = PipelineResult(
            ...
            interpretation=None,
            metadata={"pipeline": "spectral_bert", "n_clusters": n_clusters, "n_neighbors": n_neighbors, "random_state": random_state},
        )
    ...
    def run_many(
        ...
        return MultiRunPipelineResult(
            ...
            metadata={"pipeline": "spectral_bert", "n_trials": n_trials, "optuna_seed": 42, "scoring": "silhouette, calinski_harabasz, davies_bouldin"},
        )
