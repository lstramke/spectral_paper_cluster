...
class AgglomerativeBertPipeline(ExperimentPipeline):
    """Pipeline: Bert -> Agglomerative Clustering -> evaluation/interpretation with Optuna optimization."""
    ...
    def _run_single_trial(
        ...
        pipeline_result = PipelineResult(
            ...
            interpretation=None,
            metadata={"pipeline": "agglomerative_bert", "distance_threshold": distance_threshold},
        )
    ...
    def run_many(
        ...
        return MultiRunPipelineResult(
            ...
            metadata={"pipeline": "agglomerative_bert", "n_trials": n_trials, "optuna_seed": 42, "scoring": "silhouette, calinski_harabasz, davies_bouldin"},
        )
