...
Die Experimentkonfiguration liegt in [configs/spectral_tfidf.yaml](configs/spectral_tfidf.yaml).
...
outputs:
  output_dir: outputs/spectral_tfidf
...
Die Metriken werden in `outputs/spectral_tfidf/best_spectral_tfidf_summary.json` gespeichert. Für das aktuelle Experiment ergibt sich:
